    ...
    public class Common_Func
    {
        ...
        private static Dictionary<string, string> _comboBoxSql = new Dictionary<string, string> 
        {
            ...
            {"cbxWareHouse","select ID as ID,warehousename as NAME from t_Warehouse "},
             {"cbxHouse","select ID as ID,housename as NAME from t_House "},
            ...
            //物料类别
            {"cbxMaterialClass","select Maintypecode as ID,Maintypename as NAME  from t_Material_Class where Strongholdcode = 'HM1'"},
            //库区分类
