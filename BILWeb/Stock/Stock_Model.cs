...
namespace BILWeb.Stock
{
    ...
    public class T_StockInfo : BILBasic.Basing.Base_Model
    {
        //无参构造函数
        ...
        private decimal? oldstockid;
        private decimal? taskdetailesid;
        private decimal? checkid;
        private decimal? transferdetailsid;
        private decimal? returntype;
        private string returntypedesc;
        private string unit;
        private string salename;
        private string unitname;
        private string palletno;
        private decimal? receivestatus;
        ...
        public decimal? TransferDetailsID
        {
            get
            {
