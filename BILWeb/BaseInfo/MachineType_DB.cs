...
{
    public partial class T_MachineType_DB : BILBasic.Basing.Base_DB<T_MachineType>
    {
        ...
        {
            object id = OracleDBHelper.ExecuteScalar(System.Data.CommandType.Text, "SELECT COUNT(*) FROM Mes_MachineType WHERE ID='" + model.MachineTypeCode + "'");
        ...
        /// 将获取的单条数据转封装成对象返回
        /// </summary>
        protected override T_MachineType ToModel(OracleDataReader reader)
        {
            T_MachineType t_customer = new T_MachineType();

            t_customer.MachineTypeCode = OracleDBHelper.ToModelValue(reader, "ID").ToDBString();
            t_customer.MachineTypeName = OracleDBHelper.ToModelValue(reader, "NAME").ToDBString();
        ...
        protected override OracleParameter[] GetSaveModelOracleParameter(T_MachineType model)
        {
