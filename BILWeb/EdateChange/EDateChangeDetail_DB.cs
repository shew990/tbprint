...
{
    public partial class T_EDateChangeDetail_DB : BILBasic.Basing.Base_DB<T_EDateChangeDetailInfo>
    {

        /// <summary>
        /// 添加t_edatechangedetail
        /// </summary>
        protected override OracleParameter[] GetSaveModelOracleParameter(T_EDateChangeDetailInfo t_edatechangedetail)
        {
        ...
        /// 将获取的单条数据转封装成对象返回
        /// </summary>
        protected override T_EDateChangeDetailInfo ToModel(OracleDataReader reader)
        {
            T_EDateChangeDetailInfo t_edatechangedetail = new T_EDateChangeDetailInfo();

            t_edatechangedetail.ID = OracleDBHelper.ToModelValue(reader, "ID").ToInt32();
            t_edatechangedetail.HeaderID = OracleDBHelper.ToModelValue(reader, "HEADERID").ToInt32();
            t_edatechangedetail.RowNo = (string)OracleDBHelper.ToModelValue(reader, "ROWNO");
            t_edatechangedetail.MaterialNo = (string)OracleDBHelper.ToModelValue(reader, "MATERIALNO");
            t_edatechangedetail.MaterialNoID = OracleDBHelper.ToModelValue(reader, "MATERIALNOID").ToInt32();
            t_edatechangedetail.MaterialDesc = (string)OracleDBHelper.ToModelValue(reader, "MATERIALDESC");
            t_edatechangedetail.BatchNo = (string)OracleDBHelper.ToModelValue(reader, "BATCHNO");
            t_edatechangedetail.AftEDate = (DateTime?)OracleDBHelper.ToModelValue(reader, "AFTEDATE");
            t_edatechangedetail.BefEDate = (DateTime)OracleDBHelper.ToModelValue(reader, "BEFEDATE");
            t_edatechangedetail.ResoneCode = OracleDBHelper.ToModelValue(reader, "RESONECODE").ToInt32();
            t_edatechangedetail.ResoneName = (string)OracleDBHelper.ToModelValue(reader, "RESONENAME");
            t_edatechangedetail.Note = (string)OracleDBHelper.ToModelValue(reader, "NOTE");
            t_edatechangedetail.LineStatus = OracleDBHelper.ToModelValue(reader, "LINESTATUS").ToInt32();
            t_edatechangedetail.Creater = (string)OracleDBHelper.ToModelValue(reader, "CREATER");
            t_edatechangedetail.CreateTime = (DateTime?)OracleDBHelper.ToModelValue(reader, "CREATETIME");
            t_edatechangedetail.Modifyer = (string)OracleDBHelper.ToModelValue(reader, "MODIFYER");
            t_edatechangedetail.ModifyTime = (DateTime?)OracleDBHelper.ToModelValue(reader, "MODIFYTIME");
            t_edatechangedetail.ErpVoucherNo = (string)OracleDBHelper.ToModelValue(reader, "ERPVOUCHERNO");
            t_edatechangedetail.IsDel = (decimal?)OracleDBHelper.ToModelValue(reader, "ISDEL");
            t_edatechangedetail.EDate = t_edatechangedetail.BefEDate;
            t_edatechangedetail.StrongHoldCode = (string)OracleDBHelper.ToModelValue(reader, "StrongHoldCode");
            t_edatechangedetail.StrongHoldName = (string)OracleDBHelper.ToModelValue(reader, "StrongHoldName");
