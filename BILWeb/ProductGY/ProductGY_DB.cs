...
{
    public partial class Mes_ProductGY_DB : BILBasic.Basing.Base_DB<Mes_ProductGYInfo>
    {

        /// <summary>
        /// 添加t_outstock
        /// </summary>
        protected override OracleParameter[] GetSaveModelOracleParameter(Mes_ProductGYInfo t_outstock)
        {
        ...
        /// 将获取的单条数据转封装成对象返回
        /// </summary>
        protected override Mes_ProductGYInfo ToModel(OracleDataReader reader)
        {
            Mes_ProductGYInfo mes_productGY = new Mes_ProductGYInfo();

            mes_productGY.ID = OracleDBHelper.ToModelValue(reader, "ID").ToInt32();
            mes_productGY.gxID = (string)OracleDBHelper.ToModelValue(reader, "gxID");
            ...
            mes_productGY.gxSeq = OracleDBHelper.ToModelValue(reader, "gxSeq").ToInt32();
            mes_productGY.gxName = (string)OracleDBHelper.ToModelValue(reader, "gxName");
            mes_productGY.isDel = OracleDBHelper.ToModelValue(reader, "isDel").ToInt32();
            mes_productGY.description = (string)OracleDBHelper.ToModelValue(reader, "description");
            mes_productGY.imagePic = (byte[])OracleDBHelper.ToModelValue(reader, "imagePic");
            mes_productGY.videoUrl = (string)OracleDBHelper.ToModelValue(reader, "videoUrl");
        ...
        public bool SaveProductGYData(string userNo, List<Mes_ProductGYInfo> lst, ref string ErrMsg)
        {
            ...
            try
            {
                ...
                int i = OracleDBHelper.ExecuteNonQueryListByCymNew(lstSql, buttfes, ref ErrMsg);
