...
{
    public partial class Mes_ProductGYLine_DB : BILBasic.Basing.Base_DB<Mes_ProductGYLineInfo>
    {

        /// <summary>
        /// 添加t_outstock
        /// </summary>
        protected override OracleParameter[] GetSaveModelOracleParameter(Mes_ProductGYLineInfo t_outstock)
        {
        ...
        /// 将获取的单条数据转封装成对象返回
        /// </summary>
        protected override Mes_ProductGYLineInfo ToModel(OracleDataReader reader)
        {
            Mes_ProductGYLineInfo mes_productGY = new Mes_ProductGYLineInfo();

            mes_productGY.ID = OracleDBHelper.ToModelValue(reader, "ID").ToInt32();
            mes_productGY.cptype = (string)OracleDBHelper.ToModelValue(reader, "cptype");
            mes_productGY.machineType = (string)OracleDBHelper.ToModelValue(reader, "machineType");
            mes_productGY.Seq = OracleDBHelper.ToModelValue(reader, "Seq").ToInt32();
            mes_productGY.gyLineName = (string)OracleDBHelper.ToModelValue(reader, "gyLineName");
            mes_productGY.isDel = OracleDBHelper.ToModelValue(reader, "isDel").ToInt32();
            mes_productGY.cpCode = (string)OracleDBHelper.ToModelValue(reader, "cpCode");
            mes_productGY.cpName = (string)OracleDBHelper.ToModelValue(reader, "cpName");
            mes_productGY.gybbID = (string)OracleDBHelper.ToModelValue(reader, "gybbID");

            mes_productGY.Creater = (string)OracleDBHelper.ToModelValue(reader, "CREATER");
            mes_productGY.CreateTime = (DateTime?)OracleDBHelper.ToModelValue(reader, "CREATETIME");
            mes_productGY.Modifyer = (string)OracleDBHelper.ToModelValue(reader, "Modifyer");
            mes_productGY.ModifyTime = (DateTime?)OracleDBHelper.ToModelValue(reader, "ModifyTime");

            mes_productGY.remark = (string)OracleDBHelper.ToModelValue(reader, "remark");

            //todo:
            mes_productGY.StrStatus = (string)OracleDBHelper.ToModelValue(reader, "StrStatus");
            mes_productGY.StrCreater = (string)OracleDBHelper.ToModelValue(reader, "StrCreater");
        ...
        {
            object id = OracleDBHelper.ExecuteScalar(System.Data.CommandType.Text, "SELECT Max(gybbID) FROM Mes_GYLine WHERE cptype='" + cptype + "'");
        ...
        public bool SaveProductGYLineData(string userNo, Mes_ProductGYLineInfo model, ref string ErrMsg)
        {
            ...
            try
            {
                List<BILBasic.DBA.OracleDBHelper.imageButtfes> buttfes = new List<BILBasic.DBA.OracleDBHelper.imageButtfes>();
                ...
                if (model.ID > 0)
                {
                    ...
                    foreach (var gyg in model.lstGYLine_GYD)
                    {
                        foreach (var gygEntity in gyg.lstGY)
                        {
                            ...
                            buttfes.Add(new BILBasic.DBA.OracleDBHelper.imageButtfes()
                            {
                ...
                int i = OracleDBHelper.ExecuteNonQueryListByCymNewImages3(lstSql, buttfes, ref ErrMsg);
        ...
        public bool DeleteProductGYLineInfo(string gxLineID, int isdel, ref string ErrMsg)
        {
            ...
            try
            {
                ...
                int i = OracleDBHelper.ExecuteNonQueryList(lstSql, ref ErrMsg);
        ...
        public int GetMaxGYbbID_C(string cpCode, string machineType)
        {
            ...
            //object id = OracleDBHelper.ExecuteScalar(System.Data.CommandType.Text, "SELECT Max(gybbID) FROM Mes_GYLine_C WHERE cpCode='" + cpCode + "'  and machineType='" + machineType + "'");

            object id = OracleDBHelper.ExecuteScalar(System.Data.CommandType.Text, "SELECT Max(gybbID) FROM Mes_GYLine_C WHERE cpCode='" + cpCode + "'  and processMode='" + machineType + "'");
                ...
                using (OracleDataReader dr = OracleDBHelper.ExecuteReader(CommandType.Text, strSql))
                {
                    if (dr.Read())
                    {
                        ...
                        if (dr["countQty"].ToInt32() != 0)
                        {
                            ...
                            i = OracleDBHelper.ExecuteNonQueryList(lstSql, ref ErrMsg);
