...
{
    public partial class Mes_ProductGYD_DB : BILBasic.Basing.Base_DB<Mes_ProductGYDInfo>
    {

        /// <summary>
        /// 添加t_outstock
        /// </summary>
        protected override OracleParameter[] GetSaveModelOracleParameter(Mes_ProductGYDInfo t_outstock)
        {
        ...
        /// 将获取的单条数据转封装成对象返回
        /// </summary>
        protected override Mes_ProductGYDInfo ToModel(OracleDataReader reader)
        {
            Mes_ProductGYDInfo mes_productGYD = new Mes_ProductGYDInfo();

            mes_productGYD.ID = OracleDBHelper.ToModelValue(reader, "ID").ToInt32();
            mes_productGYD.gxDuanCode = (string)OracleDBHelper.ToModelValue(reader, "gxDuanCode");
            mes_productGYD.gxDuanName = (string)OracleDBHelper.ToModelValue(reader, "gxDuanName");
            mes_productGYD.bbNo = (string)OracleDBHelper.ToModelValue(reader, "bbNo");
            mes_productGYD.gxSeq = OracleDBHelper.ToModelValue(reader, "gxSeq").ToInt32();
            mes_productGYD.isDel = OracleDBHelper.ToModelValue(reader, "isDel").ToInt32();
            mes_productGYD.MachineName = (string)OracleDBHelper.ToModelValue(reader, "MachineName");
            mes_productGYD.MachineType = (string)OracleDBHelper.ToModelValue(reader, "MachineType");
            mes_productGYD.MouldCode = (string)OracleDBHelper.ToModelValue(reader, "MouldCode");

            mes_productGYD.Creater = (string)OracleDBHelper.ToModelValue(reader, "CREATER");
            mes_productGYD.CreateTime = (DateTime?)OracleDBHelper.ToModelValue(reader, "CREATETIME");
            mes_productGYD.Modifyer = (string)OracleDBHelper.ToModelValue(reader, "Modifyer");
            mes_productGYD.ModifyTime = (DateTime?)OracleDBHelper.ToModelValue(reader, "ModifyTime");

            mes_productGYD.Qty = OracleDBHelper.ToModelValue(reader, "Qty").ToInt32();
        ...
        {
            object id = OracleDBHelper.ExecuteScalar(System.Data.CommandType.Text, "SELECT count(gxDuanCode) FROM Mes_GYD WHERE gxDuanCode='" + gxDuanCode + "'");
        ...
        public bool SaveProductGYDData(string userNo, Mes_ProductGYDInfo entityGYD, ref string ErrMsg)
        {
            ...
            try
            {
                ...
                int i = OracleDBHelper.ExecuteNonQueryListByCymImages3(lstSql, buttfes, ref ErrMsg);
