    ...
    public class Alert_DB
    {
        ...
        public bool BatchAddData(List<Alert> lst, UserModel user, ref string msg)
        {
            ...
            try
            {
                ...
                int i = OracleDBHelper.ExecuteNonQueryList(lstSql, ref msg);
        ...
        private int GetID()
        {
            object id = OracleDBHelper.ExecuteScalar(System.Data.CommandType.Text, "SELECT SEQ_ALERT.NEXTVAL FROM DUAL");
