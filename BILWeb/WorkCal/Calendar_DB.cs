...
namespace BILWeb.WorkCal
{
    public class Calendar_DB
    {
        public List<WorkingCalendar> GetCalList(int year)
        {
            ...
            DataSet ds = OracleDBHelper.ExecuteDataSet(System.Data.CommandType.Text, query, para_list.ToArray());
        ...
        public bool UpdateCal(WorkingCalendar cal)
        {
            ...
            return OracleDBHelper.ExecuteNonQuery(CommandType.Text, query, para_list.ToArray()) > 0;
        }
        ...
        private int GetID()
        {
            object id = OracleDBHelper.ExecuteScalar(System.Data.CommandType.Text, "SELECT MAX(ID) FROM MES_WORKCALENDARTIME");
