...
{
    public partial class T_Supplier_DB : BILBasic.Basing.Base_DB<T_SupplierInfo>
    {

        /// <summary>
        /// 添加t_supplier
        /// </summary>
        protected override OracleParameter[] GetSaveModelOracleParameter(T_SupplierInfo t_supplier)
        {
            ...
            OracleParameter[] param = new OracleParameter[]{
              new OracleParameter("@bResult",OracleDbType.Int32),
               ...
               new OracleParameter("@v_ID", OracleDBHelper.ToDBValue(t_supplier.ID)),
               new OracleParameter("@v_SupplierNo", OracleDBHelper.ToDBValue(t_supplier.SupplierNo).ToOracleValue()),
               new OracleParameter("@v_SupplierName", OracleDBHelper.ToDBValue(t_supplier.SupplierName).ToOracleValue()),
        ...
        /// 将获取的单条数据转封装成对象返回
        /// </summary>
        protected override T_SupplierInfo ToModel(OracleDataReader reader)
        {
            T_SupplierInfo t_supplier = new T_SupplierInfo();

            t_supplier.ID = OracleDBHelper.ToModelValue(reader, "ID").ToInt32();
            t_supplier.SupplierNo = (string)OracleDBHelper.ToModelValue(reader, "SUPPLIERNO");
            t_supplier.SupplierName = (string)OracleDBHelper.ToModelValue(reader, "SUPPLIERNAME");
            t_supplier.SupplierNameEN = (string)OracleDBHelper.ToModelValue(reader, "SUPPLIERNAMEEN");
            t_supplier.SupplierAbridge = (string)OracleDBHelper.ToModelValue(reader, "SUPPLIERABRIDGE");
            t_supplier.Note = (string)OracleDBHelper.ToModelValue(reader, "NOTE");
            t_supplier.ContactPerson = (string)OracleDBHelper.ToModelValue(reader, "CONTACTPERSON");
            t_supplier.ContactTel = (string)OracleDBHelper.ToModelValue(reader, "CONTACTTEL");
            t_supplier.Mobile = (string)OracleDBHelper.ToModelValue(reader, "MOBILE");
            t_supplier.Fax = (string)OracleDBHelper.ToModelValue(reader, "FAX");
            t_supplier.Email = (string)OracleDBHelper.ToModelValue(reader, "EMAIL");
            t_supplier.IsDel = (decimal?)OracleDBHelper.ToModelValue(reader, "ISDEL");
            t_supplier.Creater = (string)OracleDBHelper.ToModelValue(reader, "CREATER");
            t_supplier.CreateTime = (DateTime?)OracleDBHelper.ToModelValue(reader, "CREATETIME");
            t_supplier.Modifyer = (string)OracleDBHelper.ToModelValue(reader, "MODIFYER");
            t_supplier.ModifyTime = (DateTime?)OracleDBHelper.ToModelValue(reader, "MODIFYTIME");
            t_supplier.Address = (string)OracleDBHelper.ToModelValue(reader, "ADDRESS");
            t_supplier.MailAddress = (string)OracleDBHelper.ToModelValue(reader, "MAILADRESS");
