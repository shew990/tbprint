...
namespace BILWeb.Login.User
{
    public class Login_DB
    {
        ...
        //    UserInfo model;
        //    using (OracleDataReader odr = OracleDBHelper.ExecuteReader(CommandType.Text, strSql))
        //    {
        //        if (odr.Read())
        //        {
        ...
        //            int i = OracleDBHelper.ExecuteScalar(CommandType.Text, strSql).ToInt32();
        //            if (i <= 0)
        //            {
        ...
        //            LoginIPLength = OracleDBHelper.ExecuteScalar(CommandType.Text, strSql, null).ToInt32();
        //        }
        ...
        //            LoginDeviceLength = OracleDBHelper.ExecuteScalar(CommandType.Text, strSql, null).ToInt32();
        //        }
        //    }
        ...
        //        OracleDBHelper.ExecuteNonQuery2(CommandType.Text, strSql);
        //        if (user.ID >= 1 && user.UserType == 1)
        //        {
